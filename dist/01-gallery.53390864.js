...
parcelHelpers.export(exports, "galleryItemsEl", ()=>galleryItemsEl);
parcelHelpers.export(exports, "galleryDom", ()=>galleryDom);
parcelHelpers.export(exports, "createdGalleryItemsEl", ()=>createdGalleryItemsEl);
...
const galleryItemsEl = createdGalleryItemsEl((0, _galleryItems.galleryItems));
const galleryDom = galleryEl.insertAdjacentHTML(`beforeend`, galleryItemsEl);
...
const lightbox = new (0, _simplelightboxDefault.default)(".gallery li a", {
    captionsData: `alt`,
    captionSelector: `img`,
